/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 77f5632fd7c4aecc8507c4bbdcb2d73c)
// Runtime types generated with workerd@1.20260617.1 2024-09-23 nodejs_compat
interface __BaseEnv_Env {
	LINEAR_TOKENS: KVNamespace;
	SESSION_STATE: KVNamespace;
	REPO_MAP: KVNamespace;
	CODING_TASKS: Queue;
	LINEAR_CLIENT_ID: "c6d0775a9850b67d3f152d567bd301ef";
	WORKER_URL: "https://linear-opencode-agent.bben-rasha.workers.dev";
	OPENCODE_SERVER_URL: "https://opencode-server-production-e1d9.up.railway.app";
}
